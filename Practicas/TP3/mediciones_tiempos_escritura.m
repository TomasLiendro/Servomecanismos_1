close all
con_01 = load('con_01.txt');
con_001 = load('con_001.txt');
con_0001 = load('con_0001.txt');
con_002 = load('con_002.txt');
con_0002 = load('con_0002.txt');
con_0005 = load('con_0005.txt');
...
s_01 = load('sin_01.txt');
s_001 = load('sin_001.txt');
s_0001 = load('sin_0001.txt');
s_002 = load('sin_002.txt');
s_0002 = load('sin_0002.txt');
s_0005 = load('sin_0005.txt');
